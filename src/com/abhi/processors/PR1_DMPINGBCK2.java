...
public class PR1_DMPINGBCK2 extends AbstractTask {
	...
	public void run() {
		try {
			...
			SmsDlrMap dlrMap = (SmsDlrMap) LoggerUtil.getObjectFromJson(jsonPayload, SmsDlrMap.class);
			String datastring = "";
