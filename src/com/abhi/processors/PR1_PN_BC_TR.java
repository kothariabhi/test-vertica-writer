...
public class PR1_PN_BC_TR extends AbstractTask {
	...
	public void run() {
		try {
			...
			PnBcTr pnBcTr = (PnBcTr) LoggerUtil.getObjectFromJson(kafkaString, PnBcTr.class);
